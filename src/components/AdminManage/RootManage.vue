<template>
    <div id="UserFeedback">
        <el-dialog :visible.sync="dialogVisible" title="编辑角色" show-close :modal="false">
            <div class="dialogContent">
                <div>
                    <span>编辑帐号：</span>
                    <el-input placeholder="请输入帐号" v-model="modifyForm.majorName" style="width: 200px;"></el-input>
                </div>
            </div>
        ...
        <div class="user-list-breadcrumb">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: '/UserFeedback' }">系统管理</el-breadcrumb-item>
                ...
                <el-table :data="tableData">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-button type="text" size="small" @click="modifyMajor(scope.$index)">编辑权限</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </div>
